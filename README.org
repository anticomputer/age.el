...
based on the Emacs EasyPG code and offers similar Emacs file handling for [[https://github.com/C2SP/C2SP/blob/main/age.md][Age
encrypted files]].

Using age.el you can e.g. maintain ~.org.age~ encrypted Org files, provide Age
encrypted authentication information out of ~.authinfo.age~, and
...
This code was ported from the EasyPG Emacs code and its original author is
Daiki Ueno <ueno@unixuser.org> who has assigned their copyright to the FSF.

As such, age.el is licensed and provided under the terms of the GPLv3.
